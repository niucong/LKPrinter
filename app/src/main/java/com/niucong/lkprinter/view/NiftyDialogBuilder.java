package com.niucong.lkprinter.view;
...
import com.niucong.lkprinter.R;
...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    public NiftyDialogBuilder withButton1Text(CharSequence text, int textColorId) {
        ...
        if (textColorId != 0) {
            mButton1.setTextColor(tmpContext.getResources().getColor(textColorId));
        }
        return this;
    }
    ...
    public NiftyDialogBuilder withButton2Text(CharSequence text, int textColorId) {
        ...
        if (textColorId != 0) {
            mButton2.setTextColor(tmpContext.getResources().getColor(textColorId));
        }
        return this;
    }
    ...
    public NiftyDialogBuilder withButton3Text(CharSequence text, int textColorId) {
        ...
        if (textColorId != 0) {
            mButton3.setTextColor(tmpContext.getResources().getColor(textColorId));
        }
        return this;
    }
